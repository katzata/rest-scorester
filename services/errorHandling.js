...
/**
 * Logs all errors in the database.
 * Since the front end will not make a request when the use enters invald data this function should remain pretty much idle. 
 * @param {Object} req The request object generated by "ExpressJs".
